...
void Cilinder() {
	...
	//Down
		//z
	glBegin(GL_TRIANGLES);
		glColor3f(0.427, 0.682, 0.007);
		glVertex3f(0.0, 0.0, 0.0);
		glColor3f(0.733, 0.423, 0.023);
		...
		glColor3f(0.525, 0, 0.490);
		glNormal3f(0.0f, 0.0f, 1.0f);
		glVertex3f(-0.25, 1.5, -0.75);
		glVertex3f(-0.75, 1.5, -0.25);		
		glVertex3f(-0.25, 0.0, -0.75);
		glVertex3f(-0.75, 0.0, -0.25);

		glColor3f(1, 0.647, 0.172);
		glNormal3f(0.0f, 0.0f, 1.0f);
		glVertex3f(0.75, 1.5, 0.25);
		glVertex3f(0.75, 1.5, -0.25);		
		glVertex3f(0.75, 0.0, 0.25);
